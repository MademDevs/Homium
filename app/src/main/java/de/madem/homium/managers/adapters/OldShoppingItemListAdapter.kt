...
@Deprecated("Old List Adapter approach")
class OldShoppingItemListAdapter(owner: LifecycleOwner, shoppingListLiveData: LiveData<List<ShoppingItem>>)
    : RecyclerView.Adapter<OldShoppingItemListAdapter.ShoppingItemViewHolder>(), Filterable {
    ...
    //data
    var data = shoppingListLiveData.value?.toMutableList() ?: mutableListOf()
    ...
    init {
        shoppingListLiveData.observe(owner, Observer { list ->
